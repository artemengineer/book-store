...
namespace BookStoreAPI.Repositories
{
    public class DatingRepository : IDatingRepository // TODO: Dating?
    {
        ...
        public async Task<bool> IsSelectedBook(int userId, int bookId) // TODO: Мне по имени метода кажется, что этот он используется примерно так - если вернул, значит книга выбрана, если не вернул, значит не выбрана. Может, возвращать bool из него?
        {
